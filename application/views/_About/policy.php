<section class="sg-section-container">
    <div class="container">
        <div class="col-md-12">
            <h3>이용약관</h3>
            <div class="sg-box" id="migration">
                <p>제1조(목적)

                    이 약관은 썸띵굿즈(SOMETHINGGOODS) 회사(전자상거래 사업자)가 운영하는 새벽1시 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리,의무 및 책임사항을 규정함을 목적으로 합니다.
                    ...
                    ①“몰” 이란 썸띵굿즈(SOMETHINGGOODS) 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
                    ...
                    ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호/모사전송번호/전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 썸띵굿즈(SOMETHINGGOODS) 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
                    ...
                    부 칙(시행일) 이 약관은 2014년 1월 1일부터 시행합니다.</p>
            </div>
        </div>
    </div>
</section>
